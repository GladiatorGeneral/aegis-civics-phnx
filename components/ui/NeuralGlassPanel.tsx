  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden rounded-2xl">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_49%,rgba(0,243,255,0.05)_50%,transparent_51%)] bg-[length:50px_50px]" />
        <div className="absolute inset-0 bg-[linear-gradient(0deg,transparent_49%,rgba(185,103,255,0.05)_50%,transparent_51%)] bg-[length:50px_50px]" />
      </div>
      ...
      <div className="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-blue-500/20 via-transparent to-purple-500/20 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
    </motion.div>
  );
}
